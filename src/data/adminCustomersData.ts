...
const firstCustomerPolicy:ExistingInsurancePolicy={id:'T1-20260041',category:'Health Insurance',insurer:'HDFC ERGO',planName:'Optima Secure',policyNumber:'TROTH-DEMO-POL-001',policyHolder:'Vivek Joshi',insuredMembers:'Self and family',sumInsured:1_000_000,premiumAmount:24_500,premiumFrequency:'Annual',startDate:'2025-10-06',renewalDate:'2026-10-05',status:'Active',purchasedThrough:'Troth',renewalReminderEnabled:true,premiumReminderEnabled:false,reminderOffsets:[30,15,7]}
...
export function buildAdminCustomers(applications:Application[]):AdminCustomer[] {
  return Object.entries(profiles).map(([name,profile],index)=>{
    ...
    const id=`CUS-${String(124+index).padStart(6,'0')}`
    return {
      id,name,type:'Individual',...profile,
      ...
      policies:id===firstAdminCustomerId?[firstCustomerPolicy]:[],
    }
  })
}
