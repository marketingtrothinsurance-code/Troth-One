...
import { BadgeCheck, Bell, Boxes, Calculator, ChartNoAxesCombined, Circle, Compass, Contact, FileText, Files, FolderCheck, LayoutDashboard, LifeBuoy, ListChecks, LogOut, Mail, Megaphone, Menu, MessagesSquare, PanelLeftClose, PanelLeftOpen, Search, Settings, Store, UserRound, Users, WalletCards, Workflow } from 'lucide-react'
...
export function AppShell({role,page,onRoleChange,onNavigate,onLogout,children}: Props) {
  ...
  const iconMap = {BadgeCheck,Bell,Boxes,Calculator,ChartNoAxesCombined,Circle,Compass,Contact,Files,FolderCheck,LayoutDashboard,LifeBuoy,ListChecks,Megaphone,Menu,MessagesSquare,PanelLeftClose,PanelLeftOpen,Search,Settings,Store,UserRound,Users,WalletCards,Workflow}
