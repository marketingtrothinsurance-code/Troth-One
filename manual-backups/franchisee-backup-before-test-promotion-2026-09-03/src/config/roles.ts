...
export const roleConfigs: Record<Role, RoleConfig> = {
  ...
  'test-franchisee': {
    label: 'Test Franchisee', shortLabel: 'Test Franchisee', user: 'Troth Meridian Financial Services', designation: 'TF-GJ-0418 · Ahmedabad', allowedProducts: allProducts, canManage: true,
    nav: [
      ['dashboard','Dashboard','LayoutDashboard'],['customers','Customers','Contact'],['crm','CRM / Sales Pipeline','Workflow'],
      ['applications','Applications & Case Tracking','Files'],['products','Products & Services','Boxes'],['support','Support & Service Desk','LifeBuoy'],
      ['configuration','Franchise Configuration','Settings'],['notifications','Communication & Notifications','Bell'],
      ['marketing','Marketing Centre','MessagesSquare'],['training','Training & Knowledge','BadgeCheck'],['business-revenue','Business & Revenue Reports','ChartNoAxesCombined']
    ].map(([id,label,icon])=>({id,label,icon}))
  },
  rm: {
