...
import { TestFranchiseeApp } from './test-franchisee/TestFranchiseeApp'
...
export default function App() {
  ...
  let content
  if (role === 'test-franchisee') content = <TestFranchiseeApp page={page} onNavigate={navigate} />
  else if (role === 'franchisee' && page === 'dashboard') content = <FranchiseeDashboard apps={visibleApplications} customers={franchiseeCustomers} leads={franchiseeLeads} notifications={franchiseeNotifications} onNavigate={navigate} onToast={setToast} />
